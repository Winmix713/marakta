...
export function IterativeDesignPreview() {
  ...
  // Előre definiált tervek az újrafelhasználhatóság érdekében
  const plans = {
    basic: [
      ...
      },
      {
        name: "Vállalati",
        price: "49",
        features: ["Korlátlan projekt", "100 GB tárhely", "24/7 támogatás", "API hozzáférés", "Dedikált szerver"],
      },
    ],
    detailed: [
      {
    ...
    advanced: [
      {
        ...
        features: ["5 projekt", "1 GB tárhely", "Email támogatás", "Alapvető analitika", "1 felhasználó"],
        popular: false,
      },
      {
        name: "Pro",
  ...
  // Táblázat adatok újrafelhasználhatósága
  const tableData = [
  ...
  // Újrafelhasználható komponens a pipa ikonhoz
  ...
  // Prompt szövegek
  const promptTexts = {
    first: `Készíts egy árazási oldalt egy SaaS alkalmazáshoz három különböző csomaggal.`,
    second: `Készíts egy árazási oldalt egy SaaS alkalmazáshoz három különböző csomaggal (Alap, Pro, Vállalati).
...
Adj hozzá egy összehasonlító táblázatot is a csomagok alatt, amely részletezi a funkciókat.`,
    third: `Készíts egy árazási oldalt egy SaaS alkalmazáshoz három különböző csomaggal (Alap, Pro, Vállalati).
Az Alap csomag legyen 9€/hó, a Pro 19€/hó, a Vállalati pedig 49€/hó.
Minden csomagnál legyen egy "Leggyakrabban választott" jelölés a Pro csomagnál.
Adj hozzá egy összehasonlító táblázatot is a csomagok alatt, amely részletezi a funkciókat.
  ...
  return (
    <div className="w-full rounded-lg border border-border overflow-hidden bg-white">
      <div className="flex items-center justify-between border-b border-border p-4">
        <h3 className="font-medium">Fokozatos Fejlesztés Előnézet</h3>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h4 className="text-sm font-medium">Változat:</h4>
          <TabsList>
            <TabsTrigger value="first">1. változat</TabsTrigger>
            <TabsTrigger value="second">2. változat</TabsTrigger>
            <TabsTrigger value="third">3. változat</TabsTrigger>
          </TabsList>
        </div>

        {/* Dinamikusan generált TabsContent a promptTexts objektum alapján */}
        {Object.entries(promptTexts).map(([key, text]) => (
          <TabsContent key={key} value={key} className="mt-0">
            <div className="bg-slate-50 p-3 rounded-md mb-4 text-sm font-mono">{text}</div>
          </TabsContent>
        ))}
      </Tabs>
                            ...
                            <ul className="space-y-3">
                              {plan.features.map((feature, j) => (
                                <li key={j} className="flex items-start">
                                  <CheckIcon className="text-green-500 mr-2 mt-0.5" />
                                  {feature}
                                </li>
                              ))}
                            </ul>

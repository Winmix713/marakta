...
export function CodeExportPreview() {
  ...
  // Kód példák
  const codeExamples = {
    generated: `import React, { useState } from 'react';
...
export default function Counter() {
  ...
  return (
    ...
    customized: `import React, { useState, useEffect, useCallback } from 'react';
...
export default function CustomCounter() {
  ...
  // Prompt szövegek
  const promptTexts = {
    generated: `Készíts egy egyszerű számláló komponenst React és Tailwind CSS használatával.`,
    customized: `Exportáld a számláló komponens kódját, hogy testreszabhassam a következő módosításokkal:
      ...
      <div className="border-t border-border">
        <div className="p-4">
          ...
          {activeView === "preview" ? (
            ...
            <div className="relative bg-slate-950 text-slate-50 p-4 rounded-md overflow-auto max-h-[500px]">
              <pre className="text-xs">{codeExamples[activeTab]}</pre>
              <Button size="sm" variant="outline" className="absolute top-2 right-2 gap-1" onClick={copyToClipboard}>
